...
Notre jeu de données contenait alors 40 000 gènes (colonnes) pour 1601 échantillons. Cependant ce grand nombre de gènes peut induire du parasitisme dans le réseau car ne comportant pas de différences d'expression significatives entre les cas et les controles. Après avoir donc séléctionner en fonction de la p-value (du test de?) (sachant qu'on aurait aussi pu les trier en fonction de : variance, Fold change, ACP trie

On se met à tester plusieurs paramêtres: 

Nombre de tour d'entrainement...

Seed fixe (sert à la comparaison entre différents modèle)
1 couche :
40 000 gènes : Accuracy : 90 %
8 000 gènes : Accuracy : 87,75% ; Accuracy :taux de similitude dans les gènes clés : 0 %, Loss ok

x couche (sachant que moins de 10 000 input = 1 ou 2 couches intermédiaires)



Puis une fois que l'on à identifier le modèle idéal on retourne sur une seed aléatoire
